...
const SEO_CONFIG = {
    ...
    site: {
        ...
        defaultImage: 'https://natacha-aviat.github.io/assets/images/Natacha_Aviat.jpeg',
        defaultLocale: {
            fr: 'fr_FR',
            en: 'en_US'
        }
    ...
    fiches: {
        'fiche-rejets': {
            fr: {
                ...
                ogType: 'product',
                ogImage: 'https://natacha-aviat.github.io/assets/images/image_carte_pollution_rejets.png',
                price: 600,
        ...
        'fiche-prelevements': {
            fr: {
                ...
                ogType: 'product',
                ogImage: 'https://natacha-aviat.github.io/assets/images/image_carte_pollution_prelevements.png',
                price: 600,
                aiProductType: 'Carte interactive',
                aiPrice: '600 EUR',
        ...
        'fiche-lycees': {
            fr: {
                ...
                ogType: 'product',
                ogImage: 'https://natacha-aviat.github.io/assets/images/image_lycees.png',
                price: 0,
                aiProductType: 'Carte interactive',
                aiPrice: 'Gratuit',
        ...
        'fiche-nyc-art': {
            fr: {
                ...
                ogType: 'product',
                ogImage: 'https://natacha-aviat.github.io/assets/images/art_NYC.png',
                price: 0,
                aiProductType: 'Carte interactive',
                aiPrice: 'Gratuit',
        ...
        'fiche-optimisation-tournees': {
            fr: {
                ...
                ogType: 'product',
                ogImage: 'https://natacha-aviat.github.io/assets/images/MaMaExpress.png',
                price: 0,
        ...
        'fiche-inventaire': {
            fr: {
                ...
                ogType: 'product',
                ogImage: 'https://natacha-aviat.github.io/assets/images/MaMaFoodScan.png',
                price: 0,
                aiProductType: 'Outil web',
                aiPrice: 'Gratuit',
                aiDataSource: 'Données client',
