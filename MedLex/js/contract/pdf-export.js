...
import { buildArticleSections, splitSections, tocDisplayTitle } from './article-guide.js';
import {
...
function buildPdfBlob(root, filename, pdfMeta) {
  ...
  function countTocOverflowPages(startY, entries) {
    ...
    entries.forEach(function (entry) {
      ...
      const pageLabel = 'p 0';
      const entryH =
        PDF_TYPO.tocTitleLineHeight + 0.4 + estimateDescHeight(entry.desc, pageLabel) + 1.8;
