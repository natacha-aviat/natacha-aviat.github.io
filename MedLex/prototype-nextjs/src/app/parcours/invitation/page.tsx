...
import { motifLabel, typeRemplacementLabel } from "@/lib/funnel-types";
    ...
    <FunnelShell step={5} backHref="/parcours/apercu">
      ...
      <div className="ac-card ac-card--flat ac-spacer-lg">
        ...
        <p className="ac-card__meta">
          Contrat de remplacement · {typeRemplacementLabel(state.questionnaire.typeRemplacement)} ·
          motif {motifLabel(state.questionnaire.motif, state.questionnaire.motifAutre)}
        </p>
      </div>
